...
outer: do j = 0, ndist -1
inner: do i = 1, nterms - 1
...
subroutine levin_acceleration(terms, nterms, mvolt, kdist, beta)
implicit none
integer, parameter :: k1 = SELECTED_INT_KIND(16)
integer, parameter :: k2 = SELECTED_REAL_KIND(10,300)
integer nterms, mvolt, maxA
...
call recursivegenerator(tempstorage, nterms, mvolt, beta)
...
complex(kind = k2) s(0:nterms-1,0:mvolt-1, 0:kdist-1), beta, tau, bu, bd
integer n, k
